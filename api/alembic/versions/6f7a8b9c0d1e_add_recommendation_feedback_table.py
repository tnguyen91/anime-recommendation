...
down_revision: str | Sequence[str] | None = "5a2b3c4d5e6f"
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_recommendation_feedback_anime_id"), "recommendation_feedback", ["anime_id"], unique=False)
    op.create_index(op.f("ix_recommendation_feedback_action"), "recommendation_feedback", ["action"], unique=False)
    op.create_index(
        op.f("ix_recommendation_feedback_recorded_at"), "recommendation_feedback", ["recorded_at"], unique=False
    )
