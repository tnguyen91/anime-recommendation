...
def main(train_model=True, run_cli=True, n_hidden=N_HIDDEN, epochs=EPOCHS,
         batch_size=BATCH_SIZE, learning_rate=DEFAULT_LEARNING_RATE, k=DEFAULT_K,
...
if __name__ == "__main__":
    ...
    main(
        ...
        n_hidden=args.n_hidden if args.n_hidden != N_HIDDEN else model_cfg['n_hidden'],
        epochs=args.epochs if args.epochs != EPOCHS else model_cfg['epochs'],
        batch_size=args.batch_size if args.batch_size != BATCH_SIZE else model_cfg['batch_size'],
